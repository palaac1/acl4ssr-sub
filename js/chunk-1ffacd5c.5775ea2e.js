(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-1ffacd5c"], {
    ...
    "25f0": function(e, t, o) {
        ...
        f = c.name != a; (u || f) && n(RegExp.prototype, a, (function() {
            var e = l(this),
            t = String(e.source),
            o = e.flags,
    ...
    9263 : function(e, t, o) {
        ...
        f && (a = function(e) {
            ...
            s && (t = f.lastIndex),
            l = i.call(d ? o: f, b),
            d ? l ? (l.input = l.input.slice(h), l[0] = l[0].slice(h), l.index = f.lastIndex, f.lastIndex += l[0].length) : f.lastIndex = 0 : s && l && (f.lastIndex = f.global ? l.index + l[0].length: t),
        ...
        m = {
            data: function() {
                ...
                if (t) {
                    ...
                    for (var l = {},
                    i = Object.keys(e.options.customBackend), a = 0; a < i.length; a++) {
                        var s = i[a].replace(/\(.*/, "");
            ...
            methods: {
                ...
                makeUrl: function() {
                    ...
                    "2" === this.advanced && ("" !== this.form.excludeRemarks && (this.customSubUrl += "&exclude=" + encodeURIComponent(this.form.excludeRemarks)), "" !== this.form.includeRemarks && (this.customSubUrl += "&include=" + encodeURIComponent(this.form.includeRemarks)), "" !== this.form.filename && (this.customSubUrl += "&filename=" + encodeURIComponent(this.form.filename)), this.form.appendType && (this.customSubUrl += "&append_type=" + this.form.appendType.toString()), this.customSubUrl += "&emoji=" + this.form.emoji.toString() + "&list=" + this.form.nodeList.toString() + "&tfo=" + this.form.tfo.toString() + "&scv=" + this.form.scv.toString() + "&fdn=" + this.form.fdn.toString() + "&sort=" + this.form.sort.toString(), this.needUdp && (this.customSubUrl += "&udp=" + this.form.udp.toString()), !0 === this.form.tpl.surge.doh && (this.customSubUrl += "&surge.doh=true"), "clash" === this.form.clientType && (!0 === this.form.tpl.clash.doh && (this.customSubUrl += "&clash.doh=true"), this.customSubUrl += "&new_name=" + this.form.new_name.toString())),
